...
const navigationSections: NavigationSection[] = [
  {
    label: "Visao geral",
    items: [{ name: "Painel", to: "/app/dashboard", caption: "Resumo do ambiente e indicadores" }]
  },
  {
    label: "Operacao",
    items: [
      { name: "Movimentacoes", to: "/app/movements", caption: "Entradas, saidas e transferencias" },
      { name: "Relatorios", to: "/app/reports", caption: "Consulta e exportacao de dados" }
    ]
  },
  {
    label: "Cadastros",
    items: [
      { name: "Bases", to: "/app/bases", caption: "Estrutura fisica e unidades" },
      { name: "Categorias", to: "/app/categories", caption: "Organizacao do catalogo" },
      { name: "Produtos", to: "/app/products", caption: "Itens e disponibilidade por base" }
    ]
  },
  {
    label: "Administracao",
    items: [
      { name: "Empresa", to: "/app/company", caption: "Identidade visual e dados da empresa", roles: ["ADMIN"] },
      { name: "Usuarios", to: "/app/users", caption: "Permissoes e acessos", roles: ["ADMIN"] }
    ]
  }
];
          ...
          <section v-for="section in visibleNavigationSections" :key="section.label">
            ...
            <div class="mt-2 space-y-1.5">
              ...
              >
                ...
                <p class="mt-1 text-xs leading-5" :class="isActive(item.to) ? 'text-slate-300' : 'text-slate-400 group-hover:text-slate-500'">
                  {{ item.caption }}
                </p>
              </RouterLink>
            </div>
